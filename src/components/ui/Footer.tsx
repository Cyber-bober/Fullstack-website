    ...
    <footer style={{ 
      ...
      <div className="container">
        ...
        <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: "24px", flexWrap: "wrap" }}>
          <a href="/privacy-policy" className="text-gray" style={{ fontSize: "13px", textDecoration: "none" }}>
            Политика конфиденциальности
          </a>
          <a href="/terms" className="text-gray" style={{ fontSize: "13px", textDecoration: "none" }}>
