  ...
  return (
    <div className="container support">
      ...
      <div className="support-main">
        <div className={`support-left ${activeTicket ? "hidden" : ""}`}>
          <div className="support-left-header glass-effect">
            <h3 style={{ margin: 0 }}>
              {userRole === "ADMIN" ? "Обращения в поддержку" : "Мои обращения"}
            </h3>
            {userRole !== "ADMIN" && (
              <button
                onClick={() => setIsNewTicketMode(!isNewTicketMode)}
          ...
          <div className="glass-effect support-ticket-list">
            {isNewTicketMode ? (
              <form onSubmit={handleCreateTicket} style={{ padding: "16px" }}>
                ...
                <button type="submit" className="btn btn-primary glass-effect w-full" disabled={sending}>
                  Создать
                </button>
              </form>
            ) : tickets.length > 0 ? (
                ...
                return (
                  ...
                  >
                    ...
                    <div className="support-ticket-item-bottom">
                      ...
                      <span style={{ background: s.bg, color: s.text, padding: "2px 8px", borderRadius: 12, fontSize: 12 }}>
                        {s.label}
                      </span>
                    </div>
                  </div>
        ...
        <Card className={`support-right ${activeTicket ? "active" : ""}`}>
          {activeTicket ? (
            <>
              <div className="support-chat-header glass-effect">
                <button className="support-back-btn" onClick={() => setActiveTicket(null)}>
                  ←
                </button>
                <div
                  style={{
                ...
                >
                  ...
                  <span
                    style={{
                      ...
                      padding: 0,
                      margin: 0,
                      color: getStatusColor(activeTicket.status).text,
                    }}
                  >
                  ...
                  <div style={{ display: "flex", gap: 8 }}>
                    {activeTicket.status === "OPEN" && (
                      <button
                        ...
                        className="btn btn-ticket glass-effect"
              ...
              <div className="support-chat-main glass-effect" ref={chatContainerRef}>
                {(activeTicket.messages || []).map((msg: any, idx: number) => {
                  ...
                  return (
                    ...
                    >
                      <p style={{ margin: 0, fontSize: 14, overflowWrap: "break-word", wordBreak: "break-word" }}>
